...
Config.Ranches = {
  ...
  ['beechers_hope'] = {
    ...
    -- The RANCH MANAGER (surveyed 2026-08-14) — one NPC for selling,
    -- butchering and ordering stock in, so the yard is not full of peds.
    -- Sits ~5 m off the barn.
    manager    = { x = -1600.26, y = -1418.35, z = 81.88, h = 7.45 },
